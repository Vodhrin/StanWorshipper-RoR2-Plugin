...
namespace StanWorshipper.Core
{
    internal static class Language
    {
        public static void Initialize()
        {
            ...
            LanguageAPI.Add("STANWORSHIPPER_PASSIVE_DESCRIPTION", "Damage inflicted by summoned Stan fragments is treated as being dealt by you.");
            ...
            LanguageAPI.Add("STANWORSHIPPER_SLOT4_ULTIMATE_DESCRIPTION", "Summons <style=cIsUtility>a powerful Stan fragment</style>. Uses a more powerful version of Poopslinger, dealing <style=cIsDamage>5x175% damage</style>.");
